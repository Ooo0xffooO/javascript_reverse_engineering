function mp_wechat(password) {
    password = password.substring(0, 16)

    let md5 = function () {
            function _(t, i) {
                let r = (t & 65535) + (i & 65535), f = (t >> 16) + (i >> 16) + (r >> 16);
                return f << 16 | r & 65535
            }
            ...
            function o(t, i) {
                t[i >> 5] |= 128 << i % 32;
                t[(i + 64 >>> 9 << 4) + 14] = i;
                let r, f, j, O, $, s = 1732584193, c = -271733879, m = -1732584194, n = 271733878;
