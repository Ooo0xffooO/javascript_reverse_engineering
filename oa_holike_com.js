...
var get_key = function(encodeType, session_id) {
    var str = session_id
...
var encodeType = 'aes'
var session_id = 'CCF41DD0A14A1FB51995A674943957A9' //从前面的响应来的
var keyObj = {}
if ("aes" === encodeType.toLowerCase()) {
    keyObj = get_key("aes", session_id);
    console.log(keyObj)
    value = CryptoJS.AES.encrypt("42412424", CryptoJS.enc.Utf8.parse(keyObj.key), {
        iv: CryptoJS.enc.Utf8.parse(keyObj.iv)
    }).toString()
} else {
    keyObj = get_key('des', session_id);
    console.log(keyObj)
